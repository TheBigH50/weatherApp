...
export default function MenuModal({ location, setLocation, isShowing, setIsShowing }) {
  ...
  return (
    <div className="flex fixed flex-col justify-evenly bg-gray-900 bg-opacity-90 min-h-screen z-20 w-screen h-screen touch-none">
      ...
      <CloseOrReset setFavorite={setFavorite} isShowing={isShowing} setIsShowing={setIsShowing} />
    </div>
  );
}
